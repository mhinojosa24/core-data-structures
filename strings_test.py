...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('bbb', 'b') is True
        assert contains('ggb', 'g') is True
        assert contains('rockock', 'ock') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('abc', 'abg') is False
        assert contains('abc', 'agz') is False
        assert contains('abc', 'fbc') is False
        assert contains('abc', 'acb') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('abcabcdabcde', 'abc') is True
        assert contains('abcabcdabcde', 'abcd') is True
        assert contains('abcabcdabcde', 'de') is True
        assert contains('abcabcdabcde', 'cda') is True
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('rbc', 'bc') == 1
        assert find_index('rbc', 'c') == 2
        assert find_index('rbc', 'b') == 1
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('rbc', 'fbc') is None
        assert find_index('rbc', 'rbt') is None
        assert find_index('rbc', 'rgc') is None
        assert find_index('rbc', 'rcb') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        assert find_index('cart martart', 'rta') == 7
        assert find_index('abcabcabcdabc', 'abcd') == 6
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('aaaaaagaaag', 'aaag') == [3, 7]
        assert find_all_indexes('bangang', 'ang') == [1, 4]
        assert find_all_indexes('cartmart', 'art') == [1, 5]
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('ghb', 'sdf') == []
        assert find_all_indexes('max', 'img') == []
        assert find_all_indexes('abh', 'abf') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        assert find_all_indexes('smart farting', 'art') == [2, 7]
